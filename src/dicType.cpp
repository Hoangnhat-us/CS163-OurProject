...
dicType::dicType(wxWindow* panel, int& dicTypeInt) : wxComboBox(panel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, nullptr, wxCB_READONLY | wxNO_BORDER)
{
